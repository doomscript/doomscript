...
// @description    Formats Links, Tracks Raids, Doesn't Afraid of Anything.
// @author         doomcat
// @version        1.2.0
// @date           02.01.2012
...
/*
License: "Kongregate Legacy of a Thousand Suns Raid Link Helper for Chat", this script, (henceforth known as "doomscript") is free to download and use unlimited times on unlimited devices. You're allowed to modify the script for personal use, but you need written permission from doomcat to distribute those modifications. If you plan to distribute doomscript in whole or in part, modified or not, as part of an application other than in userscript form, some fees may apply. Contact doomcat for pricing.
...
function main()
{
	...
	window.DC_LoaTS_Properties = {
    	...
    	storage: {
	    	...
	    	// Timestamp of last query to Raid Monitor
	    	raidMonitorLastQueryTime: "DC_LoaTS_raidMonitorLastQueryTime"
    	}
	};
		...
		window.RaidMenu = Class.create({
			initialize: function()
			{
				...
				if (typeof this.container == "undefined" || this.container == null)
				{
					...
					this.titleBarClose.src = "https://subversion.assembla.com/svn/doomscript/trunk/1.2.0/Assets/base.png";
					...
					titleBarCloseArea.setAttribute("onmouseover", "$('DC_LoaTS_raidMenuClose').src = 'https://subversion.assembla.com/svn/doomscript/trunk/1.2.0/Assets/hover.png';");
					titleBarCloseArea.setAttribute("onmouseout", "$('DC_LoaTS_raidMenuClose').src = 'https://subversion.assembla.com/svn/doomscript/trunk/1.2.0/Assets/base.png';");
